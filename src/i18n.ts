...
export const translations = {
  tr: {
    ...
    timerCountDirectionDesc: "Sürenin geriye doğru mu (10:00 → 0) yoksa 0'dan ileriye doğru mu (0 → 10:00) sayacağını seçin.",
  ...
  en: {
    ...
    timerCountDirectionDesc: "Choose whether the timer counts down (10:00 → 0) or counts up from zero (0 → 10:00).",
    timerCountDirectionDown: "Count Down (10:00 → 00:00)",
    timerCountDirectionUp: "Count Up (00:00 → 10:00)",
    minuteUnit: "Minutes",
  ...
  az: {
    ...
    timerCountDirectionDesc: "Vaxtın geriyə doğru (10:00 → 0) yoxsa 0-dan irəliyə doğru (0 → 10:00) hesablanacağını seçin.",
  ...
  ru: {
    ...
    timerCountDirectionDesc: "Выберите, должен ли таймер идти в обратном порядке (10:00 → 0) или с нуля вперед (0 → 10:00).",
    timerCountDirectionDown: "Обратный отсчет (10:00 → 00:00)",
    timerCountDirectionUp: "Прямой отсчет (00:00 → 10:00)",
    minuteUnit: "Мин.",
  ...
  de: {
    ...
    timerCountDirectionDesc: "Wählen Sie, ob der Timer rückwärts (10:00 → 0) oder von Null aufwärts (0 → 10:00) zählt.",
    timerCountDirectionDown: "Rückwärts zählen (10:00 → 00:00)",
    timerCountDirectionUp: "Aufwärts zählen (00:00 → 10:00)",
    minuteUnit: "Minuten",
